...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    payment: Schema.Attribute.Enumeration<['Visa / PayPal']>;
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    status_order: Schema.Attribute.Enumeration<['noon']>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    badge: Schema.Attribute.Enumeration<
      ['none', 'new', 'best seller', 'special offer']
    > &
    ...
    product_contents: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    product_pieces: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    sizes: Schema.Attribute.Enumeration<['S', 'M', 'L']>;
